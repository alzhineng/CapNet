...
class CODataset(data.Dataset):
    ...
    def __init__(self, image_root, gt_root,edge_root, trainsize, augmentations):
        ...
        self.egs = [edge_root + f for f in os.listdir(edge_root) if f.endswith('.png')]
        #
...
def get_loader(image_root, gt_root,edge_root, batchsize, trainsize, shuffle=True, num_workers=8, pin_memory=True, augmentation=False):
